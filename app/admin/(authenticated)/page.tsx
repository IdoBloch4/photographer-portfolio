...
export default async function AdminDashboard() {
  ...
  return (
    <div>
      <h1 className="font-display text-h1 tracking-tight text-cocoa mb-2">Dashboard</h1>
      <p className="text-mono-cap text-stone mb-12">Welcome back, {session?.user?.email}</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          ...
          <p className="mt-3 text-stone text-sm leading-relaxed">
            Hero photo and gallery series order
          </p>
        </Link>
        ...
        >
          ...
          <p className="mt-3 text-stone text-sm leading-relaxed">
            Behind the Lens bio, home page quote, contact text
          </p>
        </Link>
      </div>
    </div>
